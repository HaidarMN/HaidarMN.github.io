...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/h.svg"}],"style":[],"script":[],"noscript":[],"title":"Haidar Muhammad Naufal | Frontend Developer"};
